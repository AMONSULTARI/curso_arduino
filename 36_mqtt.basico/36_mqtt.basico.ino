...
char* mqtt_topic_pub = "curso_arduino/maria";
char* mqtt_client_id = "ESP_maria";
...
void loop() 
{
  ...
  client.publish("curso_arduino/maria/temperatura", tempStr);
  client.publish("curso_arduino/maria/humedad", humStr);
...
//Mensaje recibido en [curso_arduino/maria]: Hola Mundo
